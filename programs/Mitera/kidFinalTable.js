...
export default function KidFinalTable(props) {
            ...
            <Table className={classes.table}>
                <TableHead>
                    <TableRow>
                        ...
                        <StyledTableCell>Behaviour Points of Kids</StyledTableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {props.tableData && props.tableData.map((row,i) => (
                        <StyledTableRow key={i}>
                            <StyledTableCell >{row.behavior_points}</StyledTableCell>
                         </StyledTableRow>
                    ))}
                </TableBody>
            </Table>
