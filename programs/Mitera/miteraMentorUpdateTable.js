...
export default function MiteraMentorUpdateTable(props) {
                ...
                <TableBody>
                    {props.tableData &&  props.tableData.map((row,i) => (
                        <StyledTableRow key={i}>
                            ...
                            <Form.Check 
                              checked={props.attended && props.attended.includes(row.mentorID)}
                               onChange={(e)=>props.onChangeAttendend(row.mentorID, i)}
                            />
                            </StyledTableCell>
                            <StyledTableCell  align="center">
