...
import MiteraScoreboarTable from './miteraScoreboardTable'
...
export default class MiteraScoreboard extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      per_page: null,
      current_page: 1,tableData:[],session_dateId:"",searchTxt:"",
      loader: true
    };
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if(prevProps.programName !== this.props.programName && prevProps.programId !== this.props.programId)
    {
      this.getScore()
    }
  }
          ...
          <div className="kt-portlet kt-portlet--height-fluid">
            <div className="kt-portlet__head">
              <div className="kt-portlet__head-label">
                <h3 className="kt-portlet__head-title">{this.props.programName} Scorecard</h3>
              </div>
            </div>
                        ...
                        <Col md={10}>
                          <div className="input-group md-form form-sm form-2 pl-0">
                            ...
                            <div className="input-group-append">
                              <span className="input-group-text amber lighten-3" id="basic-text1"><i class="fas fa-search text-grey"
