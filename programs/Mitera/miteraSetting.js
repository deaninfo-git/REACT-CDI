...
export default class MiteraSetting extends Component {
            ...
            <div className="kt-portlet ">
                <div className="kt-portlet__head">
                  <div className="kt-portlet__head-label">
                    <h3 className="kt-portlet__head-title">{getItem('progName').name} Settings</h3>
                  </div>
                </div>
                ...
                <div className="kt-section">
                  ...
                  <Form
                    ...
                    >
                      ...
                      <Form.Row>
                        <span>&middot;&nbsp; Mentor to {getItem('progName').id===15 ? "adult" : "child"} configuration</span>
                        <span className="px-2">
                          <i className="kt-nav__link-icon flaticon2-contract icon-color" 
